        ...
        <form onSubmit={this.handleFormSubmit} className="editForm">
          <div className="editForm-containers">
            ...
            <div className="userSpecification">
              <h4>Do you want to update your search profile? Choose which support you are looking for...</h4>
          ...
          <button type="submit" value="Submit" className="update-Btn">Submit Form</button>
        </form>
        </div>
      </div>
    )
